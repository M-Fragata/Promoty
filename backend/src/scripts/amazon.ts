...
async function executarRobo() {
    ...
    while (true) {
        ...
        try {
            console.log("🌐 [Amazon - Teste] Iniciando varredura com fluxo assíncrono...");
            ...
            console.log(`⏱️ [Amazon] Navegador finalizou todas as URLs do bloco atual em ${tempoTotalML} segundos!`);
