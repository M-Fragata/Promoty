...
const banwords: string[] = ["capa", "capinha", "pés", "ipad", "mulher", "feminino", "cabo smartwatch", "ferramenta", "tela para", "pelicula", "película", "filament", "filamento", "ring light"] // Implementar palavras indesejáveis
